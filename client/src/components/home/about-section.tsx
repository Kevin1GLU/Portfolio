...
export default function AboutSection() {
  return (
    <section id="about" className="py-20 bg-[#1a1a1a] relative overflow-hidden">
      <div className="absolute -top-40 -right-40 w-96 h-96 rounded-full bg-[#4169E1]/10 filter blur-3xl animate-float"></div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          >
            About <span className="text-[#0AFFEF]">Me</span>
          </motion.h2>
          ...
          >
            ...
            >
              ...
              >
                <div className="w-16 h-16 mx-auto mb-3 flex items-center justify-center rounded-full bg-[#0AFFEF]/20">
              ...
              <motion.div 
                ...
                transition={{ duration: 0.3 }}
              >
                <div className="w-16 h-16 mx-auto mb-3 flex items-center justify-center rounded-full bg-[#8A2BE2]/20">
              ...
              <motion.div 
                ...
                transition={{ duration: 0.3 }}
              >
                <div className="w-16 h-16 mx-auto mb-3 flex items-center justify-center rounded-full bg-[#4169E1]/20">
